...
@interface PublishDetailViewController ()
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        ...
        switch (indexPath.row) {
            case 0:
            {
                LockyUserCell *cell = [[NSBundle mainBundle]loadNibNamed:@"LockyUserCell" owner:self options:nil].lastObject;
                return cell;
            }
                break;
            case 1:
            {
                AuthenNumberCell *cell = [[NSBundle mainBundle]loadNibNamed:@"AuthenNumberCell" owner:self options:nil].lastObject;
                return cell;
            }
                break;
            case 2:
            ...
            case 6:
            {
                ...
                cell.textLabel.text = self.titleArray[indexPath.row-3];
